...
# "doDependencies" key and not under "dependencies" or "devDependencies", and
# then during the build phase we parse that using jq, format it into the syntax
# for yarn add, and use command substitution to provide it all to Yarn.
#
