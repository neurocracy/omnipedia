...
* 6.x:
  ...
  * The following modules have been temporarily switched over to forks for Drupal 10 support:
    ...
    * [Trusted Reverse Proxy](https://github.com/Ambient-Impact/drupal-trusted-reverse-proxy)
  ...
  * Uninstalled and removed [the deprecated Swift Mailer module](https://www.drupal.org/project/swiftmailer) and [the Mail System module](https://www.drupal.org/project/mailsystem) that it required. This was only ever used for [Commerce](https://www.drupal.org/project/commerce) emails, which we haven't used for some time.
